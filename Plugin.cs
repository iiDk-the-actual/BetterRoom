...
namespace BetterRoom
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public IEnumerator GetPlayersInRoom(string room)
        {
            ...
            Dictionary<string, string> cosmetics = new Dictionary<string, string> { { "LBAAD.", "ADMINISTRATOR BADGE" }, { "LBAAK.", "MOD STICK" }, { "LBANI.", "AA CREATOR" }, { "LBADE.", "FINGER PAINTER BADGE" }, { "LBAGS.", "ILLUSTRATOR BADGE" }, { "LMAPY.", "FOREST GUIDE MOD STICK" } };
